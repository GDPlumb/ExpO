...
print("")
print("How to interpret the coeffiecients?")
print("A coefficient of X means that, if we increase/decrease that feature, we expect the model's output to increase/decrease by X")
print("The goal is to increase the model's prediction by 0.5")
print("To change a feature type: i +/-")
print("")
